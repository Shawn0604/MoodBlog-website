  ...
  return (
    <Layout>
      <div className="p-20 flex flex-col justify-center items-center">
          ...
          <button onClick={handleConfirmClick}  className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gray-900 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none mr-4" disabled={loading}>
            {loading ? "加載中..." : "確定"}
          </button>
          {emotionData && (<div className="emotion-data"><p>AI 回應：{emotionData.AIresponse}</p></div>)}
      </div>
